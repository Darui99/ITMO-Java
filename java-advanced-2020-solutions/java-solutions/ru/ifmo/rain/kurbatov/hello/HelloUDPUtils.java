...
/**
 * Contains constants and common things for {@link HelloUDPClient} and {@link HelloUDPServer}
 */
public class HelloUDPUtils {
    ...
    /**
     * {@link DatagramSocket}'s timeout
     */
    public static int TIMEOUT = 300;

    /**
     * Info logging
     * @param message is {@link String} text
     */
     ...
     * Error logging
     * @param message is {@link String} text
     * @param e is {@link Exception} error
     */
    ...
    /**
     * Get string representation of {@link DatagramPacket}'s {@code data}
     *
     * @param datagramPacket is given {@link DatagramPacket}
     * @return {@link String} of {@code datagramPacket}'s {@code data}
     */
    ...
    /**
     * Check arguments for {@code null}
     *
     * @param args is array of arguments
     * @return true if some argument is {@code null}
     */
